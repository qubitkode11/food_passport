...
const burjBitesImages = [
  encodeURI('/burj bites images/Cookie_Kunafa.png'),
  encodeURI('/burj bites images/Kinder_Kunafa.png'),
...
const categoryMarqueeImages = {
  ...
  fadefit: [...fadeFitImages, ...fadeFitImages],
  burjbites: [...burjBitesImages, ...burjBitesImages]
};
