      ...
      <div className="container mx-auto px-8 relative z-10 max-w-7xl">
        ...
        <div className="hidden md:flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-8 group cursor-pointer" onClick={() => handleNavClick('contact')}>
          <div className="max-w-2xl transition-transform duration-500 group-hover:translate-x-2">
            <h2 className="font-serif text-5xl md:text-7xl mb-6 leading-[1.1] transition-colors duration-500 group-hover:text-green-light">
              {t.footer.ctaHeading} <span className="italic text-white">{t.footer.ctaHeadingEm}</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-20 md:border-t md:border-white/10 md:pt-16">
          ...
          <div className="hidden md:block lg:col-span-3">
            <h4 className="font-sans font-bold text-white tracking-[0.2em] uppercase mb-8 text-xs">{t.footer.categoriesLabel}</h4>
          ...
          <div className="hidden md:block lg:col-span-2">
            <h4 className="font-sans font-bold text-white tracking-[0.2em] uppercase mb-8 text-xs">{t.footer.exploreLabel}</h4>
            <ul className="space-y-4">
              <li><button onClick={() => handleNavClick('story')} className="text-white/60 hover:text-green-light transition-colors duration-300 text-sm">{t.footer.ourStory}</button></li>
              <li><button onClick={() => handleNavClick('services')} className="text-white/60 hover:text-green-light transition-colors duration-300 text-sm">{t.footer.services}</button></li>
              <li><button onClick={() => handleNavClick('facilities')} className="text-white/60 hover:text-green-light transition-colors duration-300 text-sm">{t.footer.logistics}</button></li>
            </ul>
          </div>

          {/* Contact */}
          <div className="lg:col-span-3">
            <h4 className="font-sans font-bold text-white tracking-[0.2em] uppercase mb-8 text-xs">{t.footer.contactLabel}</h4>
            <ul className="space-y-6">
              <li className="text-white/60 text-sm flex items-start gap-4">
                ...
                <span>Office 3658, Ground floor,<br/>470 St Kilda Road,<br/>Melbourne VIC 3004</span>
              </li>
              <li className="text-white/60 text-sm flex items-start gap-4">
                <svg className="w-5 h-5 text-green-light flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                <div className="flex flex-col gap-1.5">
                  <div className="flex flex-col">
                    <span className="text-[10px] text-white/40 uppercase tracking-wider">Tina</span>
                    <a href="mailto:tina@foodpassport.com.au" className="hover:text-white transition-colors border-b border-white/20 pb-0.5 hover:border-white self-start">tina@foodpassport.com.au</a>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[10px] text-white/40 uppercase tracking-wider">Photini</span>
                    <a href="mailto:photini@foodpassport.com.au" className="hover:text-white transition-colors border-b border-white/20 pb-0.5 hover:border-white self-start">photini@foodpassport.com.au</a>
                  </div>
                </div>
              </li>
              <li className="text-white/60 text-sm flex items-start gap-4">
                <svg className="w-5 h-5 text-green-light flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                <div className="flex flex-col gap-1.5">
                  <div className="flex flex-col">
                    <span className="text-[10px] text-white/40 uppercase tracking-wider">Tina</span>
                    <a href="tel:+61460019597" className="hover:text-white transition-colors border-b border-white/20 pb-0.5 hover:border-white self-start">+61 460 019 597</a>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[10px] text-white/40 uppercase tracking-wider">Photini</span>
                    <a href="tel:+61414192536" className="hover:text-white transition-colors border-b border-white/20 pb-0.5 hover:border-white self-start">+61 414 192 536</a>
                  </div>
                </div>
              </li>
            </ul>
