      ...
      <div className="relative h-[60vh] min-h-[400px] w-full flex items-center justify-center overflow-hidden flex-shrink-0">
        ...
        <div className="relative z-10 text-center px-8 max-w-4xl animate-[fadeUp_0.8s_ease_forwards] mt-16">
          ...
          <h1 className="font-serif text-5xl md:text-8xl text-white mb-8 leading-tight">
            Contact <span className="italic text-white/50">Us</span>
          </h1>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-7xl py-12 md:py-16">
          <div ref={cardsRef} className="reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6 group">
              ...
              <div className="text-xs font-bold tracking-[0.2em] text-muted uppercase mb-3">Direct Contact</div>
            ...
            <div className="flex flex-col items-center text-center p-6 group">
              ...
              <div className="text-xs font-bold tracking-[0.2em] text-muted uppercase mb-3">Email Us</div>
            ...
            <div className="flex flex-col items-center text-center p-6 group">
              ...
              <div className="text-xs font-bold tracking-[0.2em] text-muted uppercase mb-3">Call Us</div>
            ...
            <div className="flex flex-col items-center text-center p-6 group">
              ...
              <div className="text-xs font-bold tracking-[0.2em] text-muted uppercase mb-3">Headquarters</div>
      ...
      <div className="w-full flex-grow flex flex-col lg:flex-row mb-16 lg:mb-24">
        ...
        <div className="w-full lg:w-1/2 flex justify-end">
          <div ref={formRef} className="reveal w-full max-w-3xl p-8 md:p-16 lg:py-24 lg:pr-24">
            <div className="mb-12">
              <h2 className="font-serif text-4xl text-navy mb-4">Send an Enquiry</h2>
              <p className="text-navy/60 font-sans text-lg">We typically reply within 24 hours.</p>
            </div>

            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="relative">
                  <input type="text" id="fname" className="peer w-full border-b border-gray-300 bg-transparent py-2 text-navy focus:outline-none focus:border-green-light transition-colors placeholder-transparent" placeholder="First Name" />
                  <label htmlFor="fname" className="absolute left-0 -top-3.5 text-xs font-bold tracking-widest text-muted uppercase transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-placeholder-shown:tracking-normal peer-placeholder-shown:font-normal peer-focus:-top-3.5 peer-focus:text-xs peer-focus:font-bold peer-focus:tracking-widest peer-focus:text-green-light">First Name</label>
                </div>
                <div className="relative">
                  <input type="text" id="lname" className="peer w-full border-b border-gray-300 bg-transparent py-2 text-navy focus:outline-none focus:border-green-light transition-colors placeholder-transparent" placeholder="Last Name" />
                  <label htmlFor="lname" className="absolute left-0 -top-3.5 text-xs font-bold tracking-widest text-muted uppercase transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-placeholder-shown:tracking-normal peer-placeholder-shown:font-normal peer-focus:-top-3.5 peer-focus:text-xs peer-focus:font-bold peer-focus:tracking-widest peer-focus:text-green-light">Last Name</label>
                </div>
              </div>

              <div className="relative">
                <input type="text" id="company" className="peer w-full border-b border-gray-300 bg-transparent py-2 text-navy focus:outline-none focus:border-green-light transition-colors placeholder-transparent" placeholder="Company" />
                <label htmlFor="company" className="absolute left-0 -top-3.5 text-xs font-bold tracking-widest text-muted uppercase transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-placeholder-shown:tracking-normal peer-placeholder-shown:font-normal peer-focus:-top-3.5 peer-focus:text-xs peer-focus:font-bold peer-focus:tracking-widest peer-focus:text-green-light">Company Name</label>
              </div>

              <div className="relative">
                <input type="email" id="email" className="peer w-full border-b border-gray-300 bg-transparent py-2 text-navy focus:outline-none focus:border-green-light transition-colors placeholder-transparent" placeholder="Email" />
                <label htmlFor="email" className="absolute left-0 -top-3.5 text-xs font-bold tracking-widest text-muted uppercase transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-placeholder-shown:tracking-normal peer-placeholder-shown:font-normal peer-focus:-top-3.5 peer-focus:text-xs peer-focus:font-bold peer-focus:tracking-widest peer-focus:text-green-light">Email Address</label>
              </div>

              <div className="relative">
                <label className="block text-xs font-bold tracking-widest text-muted uppercase mb-4">Region of Interest</label>
              ...
              <div className="relative mt-12">
                <textarea id="message" rows="4" className="peer w-full border-b border-gray-300 bg-transparent py-2 text-navy focus:outline-none focus:border-green-light transition-colors resize-none placeholder-transparent" placeholder="Message"></textarea>
                <label htmlFor="message" className="absolute left-0 -top-3.5 text-xs font-bold tracking-widest text-muted uppercase transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-placeholder-shown:tracking-normal peer-placeholder-shown:font-normal peer-focus:-top-3.5 peer-focus:text-xs peer-focus:font-bold peer-focus:tracking-widest peer-focus:text-green-light">How can we help?</label>
              </div>
        ...
        <div className="w-full lg:w-1/2 min-h-[400px] lg:min-h-full bg-off2 relative group">
          ...
          <div className="absolute bottom-12 left-12 bg-white/90 backdrop-blur-md p-6 shadow-2xl z-20 transform translate-y-4 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
            <h4 className="font-serif text-2xl text-navy mb-2">Visit Us</h4>
